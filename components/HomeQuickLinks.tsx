  ...
  return (
    <div className="flex flex-nowrap items-center justify-center gap-[clamp(6px,2.2vw,12px)] w-[min(100%,560px)]">
      ...
      <Link
        ...
        className="inline-flex items-center justify-center rounded-full whitespace-nowrap font-black uppercase text-white bg-stone-950 hover:bg-stone-900 border border-white/10 transition-all active:scale-95 text-[clamp(8px,2.2vw,10px)] tracking-[0.2em] px-[clamp(10px,3.4vw,16px)] py-[clamp(6px,1.8vw,8px)]"
      >
        X
      </Link>
    </div>
